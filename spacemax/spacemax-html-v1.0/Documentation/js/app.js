(function ($) {
    ...
    var matchHeight = function () {
        ...
        function matchHeight(){
            var groupName = $('.carosuel-slider--v2 .slide .card');
            var groupHeights = [];
    ...
    /* ---------------------------------------------
    Carosuel slider--v2 (Roadmap--v1) Carosuel Slider
    --------------------------------------------- */
    var carosuelMain = $(".carosuel-slider--v1");
    carosuelMain.slick({
        slidesToShow: 3,
        slidesToScroll: 1,
        vertical: true,
    ...
    var carosuelItem = $(".carosuel-slider--v1 .slick-slide");
    var maxHeight = -1;
    ...
    /* ---------------------------------------------
    Carosuel slider--v2 (Features--v1) Carosuel Slider
    --------------------------------------------- */
    ...
    /* ---------------------------------------------
    Carosuel slider--v3 (Testimonial--v1) Carosuel Slider
    --------------------------------------------- */
